...
* 2) write-through/bypass policy when simultaneous wr&rd to same addr
**********************************/
module SYNC_FIFO #(
	parameter WIDTH  = 32,            // data width, # of bits per word
	parameter DEPTH  = 4,             // FIFO depth, # of words
	...
	output logic       FIFO_FULL,     // indicates whether FIFO is full/empty
	output logic       FIFO_EMPTY,
	output [WIDTH-1:0] DATA_OUT       // FIFO read data
);

//--------------------------------------------------
// RAM control signals and instantiation
//--------------------------------------------------
